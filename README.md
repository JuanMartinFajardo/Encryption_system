...
WatDcrypt is a creative, experimental, and probabilistic encryption algorithm. Unlike traditional ciphers that substitute characters (e.g., 'a' → 'X'), this system encrypts the **structural positions** of each character within the message.
